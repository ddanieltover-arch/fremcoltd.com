...
export default function ContactPage() {
  ...
  return (
    <>
      <JsonLd data={[breadcrumbSchema([{ name: "Home", path: "/" }, { name: "Contact", path: "/contact" }]), localBusinessSchema(site)]} />
      <div>
        <PageBanner
          title="Contact Us"
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 lg:grid-cols-5">
          <div className="space-y-6 lg:col-span-2">
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <a href={`tel:${site.phone.replace(/\s/g, "")}`} data-track-outbound="phone" className="mt-1 block text-slate-600">{site.phone}</a>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <a href={`mailto:${site.email}`} data-track-outbound="email" className="mt-1 block text-slate-600">{site.email}</a>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
